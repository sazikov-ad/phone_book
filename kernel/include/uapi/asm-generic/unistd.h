...
/* kernel/phone_book.c */
#define __NR_phone_book_get_user 440
#define __NR_phone_book_add_user 441
#define __NR_phone_book_del_user 442

__SYSCALL(__NR_phone_book_get_user, sys_phone_book_get_user)
__SYSCALL(__NR_phone_book_add_user, sys_phone_book_add_user)
__SYSCALL(__NR_phone_book_del_user, sys_phone_book_del_user)
