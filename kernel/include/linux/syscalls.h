...
/* kernel/phone_book.c */
asmlinkage long
sys_phone_book_get_user(const char __user *surname,
			struct phone_book_user_data __user *output);
asmlinkage long
sys_phone_book_add_user(const struct phone_book_user_data __user *user);
asmlinkage long sys_phone_book_del_user(const char __user *surname);
